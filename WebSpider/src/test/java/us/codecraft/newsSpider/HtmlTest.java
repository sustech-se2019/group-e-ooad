...
public class HtmlTest {
	...
	public void testGetHrefsByJsoup(){
		Html html = new Html("<html><a href='issues'>issues</a><img src='newsSpider.jpg'/></html>","https://github.com/code4craft/webmagic/");
		...
		html = new Html("<html><base href='https://github.com/code4craft/webmagic/'><a href='issues'>issues</a><img src='newsSpider.jpg'/></base></html>");
		assertThat(html.xpath("//a[1]/@abs:href").get()).isEqualTo("https://github.com/code4craft/webmagic/issues");
		assertThat(html.xpath("//img/@abs:src").get()).isEqualTo("https://github.com/code4craft/webmagic/webmagic.jpg");
	}
}
